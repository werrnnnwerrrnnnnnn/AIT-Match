...
# Seeding MBTI Types (including "Not Sure" for users)
[
...
# Seeding Preferred MBTI Types (including "Open to All" for preferences)
[
  { value: "INTJ", label: "Architect" },
  { value: "INTP", label: "Logician" },
  { value: "ENTJ", label: "Commander" },
  ...
  { value: "ESTP", label: "Entrepreneur" },
  { value: "ESFP", label: "Entertainer" },
  { value: "open-to-all", label: "Open to All" }  # Extra option for preferences
